...
function getDjezzyFallbackOffers(): ScrapedOffer[] {
  return [
    // ── PREPAID ZID ──
    {
      ...
      features: ['Unlimited Djezzy calls'], sourceUrl: 'https://www.djezzy5g.dz/#Offer',
    },
    {
      name: 'ZID 200',
      type: OfferType.PREPAID, priceDA: 200, dataGB: 3, voiceMinutes: 60,
      smsCount: 50, validityDays: 7, network: '4G',
      features: ['Unlimited Djezzy calls', 'Free social media'], sourceUrl: 'https://www.djezzy5g.dz/#Offer',
    },
    {
      name: 'ZID 500',
      type: OfferType.PREPAID, priceDA: 500, dataGB: 10, voiceMinutes: 150,
      smsCount: 100, validityDays: 30, network: '4G',
      features: ['Unlimited Djezzy calls', 'Free Facebook'], sourceUrl: 'https://www.djezzy5g.dz/#Offer',
    },
    {
      name: 'ZID 1000',
      type: OfferType.PREPAID, priceDA: 1000, dataGB: 25, voiceMinutes: 300,
      smsCount: 200, validityDays: 30, network: '4G',
      features: ['Unlimited Djezzy calls', 'Free social media', '10 GB night data'], sourceUrl: 'https://www.djezzy5g.dz/#Offer',
    },
    {
      name: 'ZID 1500',
      type: OfferType.PREPAID, priceDA: 1500, dataGB: 40, voiceMinutes: -1,
      smsCount: 300, validityDays: 30, network: '4G',
      features: ['Unlimited calls all operators', 'Free social media', '15 GB night data'], sourceUrl: 'https://www.djezzy5g.dz/#Offer',
    },
    {
      name: 'ZID 2000',
      type: OfferType.PREPAID, priceDA: 2000, dataGB: 60, voiceMinutes: -1,
      smsCount: -1, validityDays: 30, network: '4G/5G',
      features: ['Unlimited calls all operators', 'Unlimited SMS', 'Free social media', '20 GB night data'], sourceUrl: 'https://www.djezzy5g.dz/#Offer',
    },
    ...
    // ── POSTPAID ──
    {
      ...
      smsCount: 100, validityDays: 30, network: '4G',
      features: ['Monthly billing', 'Unlimited Djezzy calls'], sourceUrl: 'https://www.djezzy5g.dz/',
    },
    {
      ...
      features: ['Monthly billing', 'Unlimited calls all operators', 'Roaming available'], sourceUrl: 'https://www.djezzy5g.dz/',
    },
    {
      name: 'Djezzy Business 4000',
      type: OfferType.POSTPAID, priceDA: 4000, dataGB: 150, voiceMinutes: -1,
      smsCount: -1, validityDays: 30, network: '4G/5G',
      features: ['Monthly billing', 'Unlimited calls all operators', 'Unlimited SMS', 'International roaming', '5G priority'], sourceUrl: 'https://www.djezzy5g.dz/',
    },
    // ── DATA ONLY ──
    {
      ...
      features: ['Data only', 'Tablet/router compatible'], sourceUrl: 'https://www.djezzy5g.dz/',
    },
    {
      name: 'Djezzy Data 1000',
      type: OfferType.DATA_ONLY, priceDA: 1000, dataGB: 35, voiceMinutes: 0,
      smsCount: 0, validityDays: 30, network: '4G',
      features: ['Data only', 'Tablet/router compatible', '10 GB night bonus'], sourceUrl: 'https://www.djezzy5g.dz/',
    },
  ]
}
